...
        <!--左侧导航 #start -->
         <div class="nav left-nav">
            <div class="nav-item">
               <span class="v-link clickable dark" onclick="javascript:window.location='/user'">实现认证</span>
            </div>
            <div class="nav-item ">
...
                就诊人信息
        ...
        <div class="content-wrapper">
            ...
            <el-form-item label="姓名：" prop="name">
                <el-input v-model="patient.name" placeholder="请输入真实姓名全称" class="input v-input"></el-input>
            </el-form-item>
            
            <el-form-item label="证件类型：" prop="certificatesType">
                <el-select v-model="patient.certificatesType" placeholder="请选择证件类型" class="v-select patient-select">
                  <el-option v-for="item in certificatesTypeList" :label="item.name" :value="item.value" :key="item.value">
                  </el-option>
                </el-select>
            </el-form-item>

            <el-form-item label="证件号码：" prop="certificatesNo">
                <el-input v-model="patient.certificatesNo" placeholder="请输入证件号码" class="input v-input"></el-input>
            </el-form-item>
           
...
  
            <el-form-item label="出生日期：" prop="birthdate">
                <el-date-picker v-model="patient.birthdate"
                    class="v-date-picker"
                    type="date"
                    placeholder="选择日期">
                </el-date-picker>
            ...
            <el-form-item label="手机号码：" prop="phone">
                <el-input v-model="patient.phone" placeholder="请输入手机号码" maxlength="11" class="input v-input"></el-input>
            </el-form-item>
            
          </el-form>
        </div>
...
                    :props="props"></el-cascader>
               ...
               <el-form-item label="详细地址：" prop="address">
                   <el-input v-model="patient.address" placeholder="应公安机关要求，请填写现真实住址" class="input v-input"></el-input>
               </el-form-item>
              
            </el-form>
        </div>
        ...
        <div class="content-wrapper">
            <el-form :model="patient" label-width="110px" label-position="left">
              <el-form-item label="姓名：" prop="contactsName">
                  <el-input v-model="patient.contactsName" placeholder="请输入联系人姓名全称" class="input v-input"></el-input>
              </el-form-item>
              ...
              <el-form-item label="证件号码：" prop="contactsCertificatesNo">
                  <el-input v-model="patient.contactsCertificatesNo" placeholder="请输入联系人证件号码" class="input v-input"></el-input>
              </el-form-item>

              <el-form-item label="手机号码：" prop="contactsPhone">
                  <el-input v-model="patient.contactsPhone" placeholder="请输入联系人手机号码" class="input v-input"></el-input>
              </el-form-item>
            </el-form>
        </div>
        </div>
