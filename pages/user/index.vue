           ...
           <el-form :model="userAuth" label-width="110px" label-position="left">
              <el-form-item prop="name" label="姓名: "  class="form-normal">
                  <div class="name-input">
                      <el-input v-model="userAuth.name" placeholder="请输入联系人姓名全称" class="input v-input"></el-input>
                  </div>
              </el-form-item>
               
      
              ...
              <el-form-item label="证件类型：" prop="certificatesType">
                  <el-select v-model="userAuth.certificatesType" placeholder="请选择证件类型" class="v-select patient-select">
                    <el-option v-for="item in certificatesTypeList" :label="item.name" :value="item.name" :key="item.value"></el-option>
                  </el-select>
              </el-form-item>

              <el-form-item label="证件号码：" prop="certificatesNo">
                  <el-input v-model="userAuth.certificatesNo" placeholder="请输入联系人证件号码" class="input v-input"></el-input>
              </el-form-item>
                     ...
                     <div class="avatar-uploader">
                         <el-upload  class="avatar-uploader" :action="fileUrl" :show-file-list="false" :on-success="onUploadSuccess">
                            <div class="upload-inner-wrapper">
                                ...
                                <div v-if="!userAuth.certificatesUrl" class="text"> 上传证件照 </div>
                            </div>
                         </el-upload>
                     </div>
...
          <div>
            <el-form :model="formData" label-width="110px" label-position="right">
             ...
             <el-form-item label="姓名：" prop="name" class="form-normal">
                 <div class="name-input">
                     {{userInfo.name}}
                 </div>
             </el-form-item>
