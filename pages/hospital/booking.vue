...
            <!-- 就诊人，选中显示 -->
            <div class="sub-title" v-if="patientList.length > 0">
             ...
             <span class="card-tips"><sapn class="iconfont"></sapn> 如您持社保卡就诊，请务必选择医保预约挂号，以保证正常医保报销 </span>
            </div>
...
               
                <el-form-item label="医生专长：">
                    <div class="content"><sapn>{{ schedule.skill }}</sapn></div>
                </el-form-item>
                
...
        if(this.submitBnt == '正在提交'){
        ...
        this.submitBnt = '正在提交'
        orderApi.submitOrder(this.scheduleId, this.patient.id)
                .then(response => {
